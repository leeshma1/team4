...
//string connStringTicketbooking = builder.Configuration.GetConnectionString("TicketbookingConnStr");

//builder.Services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(connStringTicketbooking));
